...
![DCF valuation output comparing PepsiCo's current share price against the model-implied valuation.](./screenshots/dcf-share-price-output.png)

*DCF valuation output comparing PepsiCo's current share price against the model-implied valuation.*

![Projected unlevered free cash flow forecast used in the valuation model.](./screenshots/projected-free-cash-flow.png)

*Projected unlevered free cash flow forecast used in the valuation model.*
